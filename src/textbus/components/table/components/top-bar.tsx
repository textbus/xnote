...
import { Slot, Selection, ExtractComponentInstanceType, fromEvent } from '@textbus/core'
                      ...
                      <td style={{ width: i + 'px', minWidth: i + 'px' }}>
                        {
                          index === 0 && (
                            <span class="insert-btn-wrap" style={{
                              ...
                              props.component.extends.insertColumn(0)
                            }}>
                        ...
                        <span class="insert-btn-wrap" onClick={() => {
                          props.component.extends.insertColumn(index + 1)
                        }}>
                          <button class="insert-btn" type="button">+</button>
                        </span>
                      </td>
